...
Training neural network: Training and validation loss decreased and then plateaued around 10−3
, suggesting the small MLP learned the restricted 2-link inverse mapping reasonably well. Since train and validation loss remained close, there was no strong sign of overfitting. Further evaluation should focus on end-effector error rather than only angle MSE.